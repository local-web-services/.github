...
| [sample-project-hcl](https://github.com/local-web-services/local-web-services/tree/main/sample-project-hcl) | Terraform | Same patterns using Terraform instead of CDK |
